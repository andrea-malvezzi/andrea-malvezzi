...
- [setup-web-env](https://github.com/andrea-malvezzi/setup-web-env) - Lightweight bash script to scaffold a web dev environment (VSCode + Prettier, TailwindCSS + DaisyUI, Node). Built for my static landing pages freelancing side business.
- [better-summary](https://github.com/andrea-malvezzi/better-summary) - An Obsidian Plugin that generates a headers summary based on document hierarchy. Built to better organize my documentation and personal notes.

## Currently working on ...
- rematches: an alarm app for people who struggle to get out of bed - like myself.
